...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full bg-white rounded-lg shadow-xl p-8 text-center">
        <div class="mb-6">
            ...
            <p class="text-gray-600 mb-4">{{ $message ?? 'The system is currently under maintenance. Please check back later.' }}</p>
        </div>
        ...
        <div class="mt-6 text-xs text-gray-400">
            <p>If you're an administrator, you can access the <a href="{{ url(config('cms.admin_prefix') . '/updates') }}" class="text-blue-600 hover:text-blue-800">updates page</a> to manage maintenance mode.</p>
        </div>
    </div>
</body>
</html>