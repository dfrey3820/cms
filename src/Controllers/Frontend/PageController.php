    ...
    public function install(Request $request)
    {
        ...
        if ($request->ajax() || $request->header('X-Requested-With') === 'XMLHttpRequest') {
            return response()->json([
                ...
                'redirect' => route('cms.admin.login')
            ]);
        }
...
<body class="bg-gradient-to-br from-blue-50 via-white to-indigo-50 min-h-screen">
    ...
    {
        $html = '<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="csrf-token" content="' . csrf_token() . '"><title>Reset Password - Buni CMS</title><link rel="stylesheet" href="' . asset('vendor/cms/tailwind.css') . '">';
        $html .= (app()->bound(\Buni\Cms\Services\HookManager::class) ? (function () { ob_start(); app(\Buni\Cms\Services\HookManager::class)->doAction('cms_enqueue_scripts'); return ob_get_clean(); })() : '');
        ...
        return '<div class="space-y-8">
            ...
            <div class="bg-green-50 border border-green-200 rounded-xl p-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <a href="' . route('cms.admin.login') . '" class="inline-flex items-center justify-center px-6 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all duration-200">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
